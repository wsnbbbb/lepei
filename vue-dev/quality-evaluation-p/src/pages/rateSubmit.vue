...
export default {
    ...
    methods:{
        ...
        init(){
            ...
            axios.post(baseUrl+'/parent/quality-valuation/quotas-list', JSON.stringify({
                  uid: this.user.uid,
              ...
              .then(function (response) {
                  ...
                  .then(function (response) {
                      this.showLoading=false
                      // this.scoreLevel=response.detail;
        ...
        submit(){
          ...
          axios.post(baseUrl+'/parent/quality-valuation/point-score-apply',JSON.stringify({
            uid:this.user.uid,
            token:this.user.token,
            personId:this.user.personId,
            // studentId:studentId,
