<template>
    <div>
       <ul>
         <li class="item-li"  v-on:click.stop="openUrl('teacher-word-detail',list.semesterId,list.status)" v-for="list in listArr" v-bind:id="list.semesterId">
           <img src="../assets/bg14.jpg" alt="">
           <div class="li-info">
...
export default {
    ...
    methods:{
        init(){
          axios.post(baseUrl+'/parent/quality-valuation/comment-list', JSON.stringify({
              uid: this.user.uid,
