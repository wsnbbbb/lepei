...
import {getAreaList,getBase, setBase,} from '../api/request'
import {Decrypt} from '../util/secret'
import {getQueryString, stringCheck, getBirthdayFromIdCard,getFormatDate} from '../util/util'
        ...
        methods:{
            ...
            async getBase(){
                ...
                if(res.success){
                    ...
                    this.gradeClass = res.detail.gradeTypeName + res.detail.gradeName + res.detail.className
             ...
             async setBase(type){
                ...
                if(this.domicileType == 0){
                    Toast.fail('户籍所在地类型不能为空');
                    return
                }
