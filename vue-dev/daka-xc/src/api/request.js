...
export const getJourningHistory  = (params) =>{
    return post('/api/sojourning-history/list',params)
}

export const addJourningHistory  = (params) =>{
    return post('/api/sojourning-history/add',params)
}

export const getJourningDetail  = (params) =>{
    return post('/api/sojourning-history/detail',params)
}
