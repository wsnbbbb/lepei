...
if (process.env.NODE_ENV == 'development') {
  ...
  axios.defaults.baseURL = 'http://111.231.192.93:12003';//准生产网址      
  // axios.defaults.baseURL = 'http://192.168.31.178:8097';//王飞电脑
} else {
  // axios.defaults.baseURL = 'http://192.168.1.22:8083';
  // axios.defaults.baseURL = 'http://110.185.100.173:9901';
  // axios.defaults.baseURL = 'https://scxc.lepayedu.com:12003';
  axios.defaults.baseURL = 'http://111.231.192.93:12003';//准生产网址
  // axios.defaults.baseURL = 'http://api.lepayedu.com';

  // https://111.231.192.93:12005/
