...
export default {
    ...
    mounted(){
      if(this.isiOS){
        ...
        localStorage.setItem("userInfo", window.app.publicParameters())
        localStorage.setItem("personId", window.app.getCurrentCardId())
      }
    ...
    methods:{
      ...
      postCurrentCardId(result){
        localStorage.setItem("personId", result)
      },
      ...
      getOrder(){
        this.showLoading=true;
        axios.post(baseUrl+'/parent/card/new-make-recharge-order', JSON.stringify({
            uid: JSON.parse(localStorage.getItem("userInfo"))["uid"],
            token: JSON.parse(localStorage.getItem("userInfo"))["token"],
            personId: localStorage.getItem("personId"),
            amount: this.money
      ...
      pay(){
        ...
        axios.post(baseUrl+'/parent/card/new-channel', JSON.stringify({
            uid: JSON.parse(localStorage.getItem("userInfo"))["uid"],
            token: JSON.parse(localStorage.getItem("userInfo"))["token"],
