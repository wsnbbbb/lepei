...
import {baseUrl,user,redirectUrlAndroid,redirectUrlIos} from '../config/env'
            ...
            if(response.data.success){
              // debugger;
               var u = navigator.userAgent;
                ...
                if(isAndroid){
                   window.location.href=response.data.detail+"&redirect_url="+urlencode(redirectUrlAndroid)+"/pay"
                }else{
                    window.app.notice();
