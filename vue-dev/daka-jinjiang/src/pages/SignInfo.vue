        ...
        <van-radio-group v-model="currentInChengdu" >
            <van-cell-group title="当日居住区情况">
                ...
                <van-cell title="省内（除成都以外地区）" clickable @click="currentInChengdu = '2'">
                 ...
                 <van-cell title="省外（湖北省）" clickable @click="currentInChengdu = '3'">
                    <van-radio slot="right-icon" name="3" />
                </van-cell>
                <van-cell title="省外（浙江、广东、河南、湖南、江西、重庆、安徽、北京、海南）" clickable @click="currentInChengdu = '4'">
                    <van-radio slot="right-icon" name="4" />
                </van-cell>
                <van-cell title="其他省份" clickable @click="currentInChengdu = '5'">
                    <van-radio slot="right-icon" name="5" />
                </van-cell>
            </van-cell-group>
        </van-radio-group>
         <!-- <van-radio-group v-model="isResidence"  v-show="currentInChengdu==0">
            <van-cell-group title="当日居住地与户籍一致">
                <van-cell title="是" clickable @click="isResidence = '1'">
                    <van-radio slot="right-icon" name="1" />
                </van-cell>
                <van-cell title="否" clickable @click="isResidence = '2'">
                    <van-radio slot="right-icon" name="2" />
                </van-cell>
            </van-cell-group>
        </van-radio-group> -->
...
import {getAppoint, punch,getAreaList} from '../api/request'
    ...
    export default {
        data(){
            return {
                ...
                hasInEpicentersText: '，是否有疫情严重地区（湖北、浙江、广东、河南、湖南、江西、重庆、安徽、北京、海南）旅行或居住史',
