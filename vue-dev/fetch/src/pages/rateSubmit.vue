     ...
     <ul class="list">
      ...
      <section class="content">
        <div class="content-item" v-for="(item,index) in list">
            ...
            <ul>
              <li class="item-list" v-for="(li,index) in item.points">
                <p>{{index+1}}.{{li.title}}</p>
                <div class="drag-bar">
                   <div class="bar-total bar" id="bar">
                      <img src="../assets/icon-bar.png" alt="" class="block" v-bind:pointId="li.pointId"/>
                   </div>
                   <span>
                      <span class="score-span">{{li.score<0?"0.0":li.score}}</span>
    ...
    methods:{
        ...
        submit(){
         ...
         previewAttach(url){
          console.log(url);
          if(this.isiOS()){
            window.webkit.messageHandlers.openClientUrl.postMessage('http://view.officeapps.live.com/op/view.aspx?src='+url);
          }else{
            window.app.openClientUrl('http://view.officeapps.live.com/op/view.aspx?src='+url);
          }
         },
