    ...
    <div class="list-wrap">
       ...
       <section class="list">
        ...
        <div class="description-box">  
          <textarea name="" id="" cols="30" rows="10" placeholder="请输入物品用途（必填）" maxlength="100"  @input="descInput" v-model="desc" ></textarea> 
          <span class="number-box"><span>{{remnant}}</span>/100</span>
        </div>
       <div  class="btn-box"> 
