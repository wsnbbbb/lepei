<template>
  <el-row class="container">
      ...
      <el-col :span="4" class="userinfo">
        <el-dropdown trigger="hover">
          <span class="el-dropdown-link userinfo-inner">
            <img :src="schoolLogo ? imgBase + schoolLogo : defaultImg" alt="" />
            {{ sysUserName }}
          </span>
    ...
    <el-col :span="24" class="main">
        ...
        >
          <template v-for="(item, index) in $router.options.routes" v-if="!item.hidden">
            <el-submenu :key="index" :index="index + ''" v-if="!item.leaf">
              ...
              <el-menu-item v-for="child in item.children" :index="child.path" :key="child.path" v-show="!child.hidden">
                {{ child.meta.title }}
              </el-menu-item>
            </el-submenu>
      ...
      <section class="content-container" v-if="activeItem == 1">
        <div class="grid-content bg-purple-light">
          ...
          <el-col :span="24" class="content-wrapper">
            <transition name="fade" mode="out-in">
              <keep-alive :include="includeRoute" :max="keepAliveMaxNum">
      ...
      <section class="content content-container" v-else-if="activeItem == 2 || activeItem == 3">
        <div class="grid-content bg-purple-light">
          <el-col :span="24" class="content-wrapper">
            <transition name="fade" mode="out-in">
              <keep-alive :include="includeRoute" :max="keepAliveMaxNum">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        includeRoute: "keepRoutes/includeRoute",
        excludeRoute: "keepRoutes/excludeRoute",
      }),
      key() {
    ...
    mounted() {
      ...
      this.schoolLogo = sessionStorage.getItem("logo");
      ...
      if (activeItem == 1) {
        this.sysName = "乐陪门禁管理后台";
      } else if (activeItem == 2) {
        this.sysName = "乐陪蓝牙管理平台";
