	...
	<section>
		...
		<el-table :data="users" highlight-current-row  @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="nextTimeSlot" label="关联时间序号" min-width="120">
				 <template slot-scope="scope">
					...
					<el-button size="medium" v-if="scope.row.nextTimeSlot>0" type="text" @click="preView(scope.$index, scope.row)">预览</el-button>
                </template>
			</el-table-column>
		...
		<el-dialog title="预览" width="80%" class="preview-dialog" :visible.sync="previewVisible" :close-on-click-modal="false">
			...
			<div slot="footer" class="dialog-footer">
				<el-button size="medium" @click.native="previewVisible = false">关闭</el-button>
			</div>
		</el-dialog>
		...
		<el-dialog title="添加终端" :visible.sync="addFormVisible" :close-on-click-modal="false">
			...
			<div slot="footer" class="dialog-footer">
				...
				<el-button type="primary" size="medium"  @click.native="addSubmit" :loading="addLoading">提交</el-button>
			</div>
		</el-dialog>
	</section>
</template>
