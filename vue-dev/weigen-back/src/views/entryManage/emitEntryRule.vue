	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" size="medium"  v-on:click="handleDistribute(1)">全量下发策略</el-button>
				</el-form-item>
				<!-- <el-form-item>
					<el-button type="primary" size="medium"  @click="handleDistribute(2)">增量下发策略</el-button>
				</el-form-item> -->
				<el-form-item>
					<el-button type="primary" size="medium"  @click="getEntryRuleSend">刷新</el-button>
				</el-form-item>
			</el-form>
		</el-col>
