		 ...
		 <el-tabs v-model="activeName">
			<el-tab-pane label="学生手环" name="first">
					...
					<el-form :inline="true" :model="filters1" ref="filters">
						<el-row :gutter="24">
							...
							<el-col :span="6" style="text-align: right">
								...
								<a :href="exportUrl1" @click="listExport1"><el-button type="primary" size="medium">导出</el-button></a>
							</el-col>
						</el-row>
				...
				<el-table max-height="700" :data="studentRecord" highlight-current-row  style="width: 100%;">
					...
					<el-table-column prop="electric" label="电量" min-width="60">
						<template slot-scope="scope">
							<p>{{(scope.row.electric?scope.row.electric+"%":"-")}}</p>
						</template>
					</el-table-column>
					<el-table-column prop="updateTime" label="记录时间" min-width="120" :show-overflow-tooltip="true" :formatter="formatTime">
					</el-table-column>
					...
					<el-form :inline="true" :model="filters2" ref="filters2">
						<el-row :gutter="24">
							...
							<el-col :span="6" style="text-align: right">
								...
								<el-button type="primary" size="medium" @click="resetForm('filters')" plain>重置</el-button>&emsp;
								<a :href="exportUrl2" @click="listExport2"><el-button type="primary" size="medium">导出</el-button></a>
							</el-col>
						</el-row>
					...
					<el-form :inline="true" :model="filters3" ref="filters3">
						<el-row :gutter="24">
							...
							<el-col :span="6" style="text-align: right">
								...
								<a :href="exportUrl3" @click="listExport3"><el-button type="primary" size="medium">导出</el-button></a>
							</el-col>
						</el-row>
					</el-form>
				</el-col>
...
<script>
	...
	import { getGrade,
	getClasses, getBuilds, getGradesByType, getElectricList, getBraceletDetail, updateMac, sendUserInfo, batchSendUserInfo} from '../../api/api';
	...
	export default {
		...
		methods: {
			...
			listExport1() {
				...
				let url = util.portUrl("/ssw-bluetooth/person-electric/export?userId=" + userId + "&accessToken=" + token + "&personType=" + personType + "&kw=" + kw + 
				"&gradeType=" + gradeType + "&gradeId=" + gradeId + "&classId=" + classId )
				this.exportUrl1 = url
			},
			// 导出
			listExport2() {
