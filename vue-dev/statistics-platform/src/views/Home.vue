		...
		<el-col :span="24" class="main">
			...
			<section class="content-container" >
				<div class="grid-content bg-purple-light">
					...
					<el-tabs type="card" v-model="activeName"  v-show="isShow" style="padding-top: 15px" @tab-click="handleClick">
						<el-tab-pane name="student-statistics" label="师生统计"></el-tab-pane>
						<el-tab-pane name="administration-statistics" label="行政统计"></el-tab-pane>
						<el-tab-pane name="device-staistics" label="终端统计"></el-tab-pane>
					</el-tabs>
