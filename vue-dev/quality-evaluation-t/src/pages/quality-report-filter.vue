<template>
    <div>
      ...
      <div class="person-box">
        <ul>
          <li class="person-li" v-for="list in personList"  v-bind:id="list.personId" v-on:click.stop="openUrl(list.personId,$event)"  >
    ...
    methods:{
        ...
        openUrl(studentId,event){
          if(this.showSelect!=true){
            ...
            this.$router.push({ path: "evaluation-report-parent"});
          }else{
            ...
            var selectAll=true;
            for(var i=0;i<obj.length;i++){
              if(!this.hasClass(obj[i],"selected")){
                selectAll=false;
              }
            }
            if(selectAll!=true){
