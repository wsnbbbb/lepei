...
export const getWeather = (param) => fetch(baseUrl + '/exhibition/weather/info', param ,'POST');

export const getEvaluation = (param) => fetch(baseUrl + '/exhibition/school-data/special-moral-education-evaluation-show', param ,'POST');

export const getEvaluationFlag = (param) => fetch(baseUrl + '/exhibition/school-data/moral-education-evaluation-flag', param ,'POST');
