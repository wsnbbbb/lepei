  ...
  <div class="evaluation-report">
    <div class="info space">
      <!-- <van-row class="box">
        ...
        <van-col span="17" offset="2">{{ reportDetail.applyPersonName }}</van-col>
      </van-row>
      <van-row class="box">
        <van-col class="left" span="5">提交时间</van-col>
        <van-col span="17" offset="2">{{ reportDetail.applyTime }}</van-col>
      </van-row>
      <van-row class="issue">
        <van-col class="left" span="5">发布对象</van-col>
        <van-col span="17" offset="2">{{ reportDetail.target }}</van-col>
      </van-row> -->
       <van-row class="box">
...
@Component({})
export default class GrowthAssessment extends Vue {
  private msg: string = "";
