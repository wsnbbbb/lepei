...
import { RelateDetailParm, examineLeave, clickExamine } from "../types/index"; 


@Component({})
export default class TeacherLeave extends Vue {
  ...
  private detailList: examineLeave = {
    portrait: "",
    examines: [],
    copyPersons: [],
    applyPersonName: "",
