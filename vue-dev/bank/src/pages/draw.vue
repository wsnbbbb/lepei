<template>
    <div>
      ...
      <a href="javascript:;" class="login-btn save-btn" v-on:click.stop='save'>取出</a>
      ...
      <div class="result-mask-box" v-show="showSuccess" @touchmove.prevent>
          <div class="result-mask">
              <img src="../assets/icon-a10.png" alt="">
              <p>
                <span>{{name}}</span>，<span>{{className}}</span><br/>
                取出<span class="green">{{money}}</span>元，当前存款总计<span class="green">{{totalMoney}}</span>元
              </p>
      ...
      <div class="result-mask-box result-mask-box-fail" v-show="showFail" @touchmove.prevent>
          <div class="result-mask">
              <img src="../assets/icon-a11.png" alt="">
              <p>
                温馨提示：<br/>
                <span>{{failText}}</span>
              </p>
