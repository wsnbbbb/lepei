<template>
	<el-form :model="form" :rules="rules" ref="form"  label-width="120px" style="margin:20px;width:90%;min-width:600px;">
		...
		<el-form-item label="策略终端">
			...
			<el-button type="primary" v-on:click="getDev" :disabled="selectTeacherList.length>0||selectStudentList.length>0">添加终端</el-button>
		</el-form-item>
		<el-form-item>
		...
		<el-form-item label="选择时段">
			<span class="span-label">*</span>
			<el-button type="primary" v-on:click="getTimeSlot" :disabled="selectTeacherList.length>0||selectStudentList.length>0">选择时段</el-button>
		</el-form-item>
		...
		<el-form-item label="策略人员">
			...
			<el-table :data="selectTeacherList" highlight-current-row @selection-change="selsChange1" style="width: 100%;">
				...
				<el-table-column prop="depart" label="所属组织" min-width="120" :formatter="formatResidence">
				</el-table-column>
				<el-table-column prop="telephone" label="电话" min-width="120">
				</el-table-column>
			</el-table>
			<el-col :span="24" class="toolbar">
				<el-pagination layout="total, prev, pager, next" :current-page="page" @current-change="handleCurrentChange" :page-size="20" :total="selTeacherList.length" style="float:right;">
				</el-pagination>
			</el-col>
		</el-form-item>
		...
		<el-dialog title="管理策略人员" width="80%" class="preview-dialog" v-model="personVisible1" :close-on-click-modal="false">
			<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			...
			<el-table :data="teacherList" highlight-current-row row-key="personId" @selection-change="selsChange2" style="width: 100%;">
				...
				<!--工具条-->
			<el-col :span="24" class="toolbar">
				<el-pagination @size-change="handleSizeChange1" :page-sizes="[100, 200, 300, 400]" layout="sizes, total, prev, pager, next" :current-page.sync="page1" @current-change="currentChange1" :page-size="pageSize1" :total="total1" style="float:right;">
				</el-pagination>
			</el-col>
			<div class="dialog-btn">
