	...
	<el-form :model="form" :rules="rules" ref="form"  label-width="120px" style="margin:20px;width:60%;min-width:600px;">
		...
		<el-form-item label="时段有效期限" required>
				...
				<el-form-item prop="startDate">
					<el-date-picker type="date" placeholder="开始日期" @change="getSTime1" v-model="form.startDate" style="width: 100%;"></el-date-picker>
				</el-form-item>
				</el-col>
				<el-col class="line" :span="2">&nbsp;&nbsp;&nbsp;&nbsp;~</el-col>
				<el-col :span="11">
				<el-form-item prop="endDate">
					<el-date-picker placeholder="结束日期" @change="getSTime2" v-model="form.endDate" style="width: 100%;"></el-date-picker>
				</el-form-item>
				</el-col>
		</el-form-item>
		...
		<el-form-item label="关联时段">
			<el-button type="primary" :disabled="!this.form.index" v-on:click="getTimeSlot">选择</el-button>
			<el-button v-on:click="clearTimeSlot">清空</el-button>
		</el-form-item>
		<el-form-item>
			...
			preViewEntryTime() {
				...
				preViewEntryTime(para).then((res) => {
					if(res.code==200){
						...
						this.time1 = res.data.timeSections[0]&&[new Date("Jun 2,2017 "+ res.data.timeSections[0][0]), new Date("Jun 2,2017 "+ res.data.timeSections[0][1])]
						this.time2 = res.data.timeSections[1]&&[new Date("Jun 2,2017 "+ res.data.timeSections[1][0]), new Date("Jun 2,2017 "+ res.data.timeSections[1][1])]
						this.time3 = res.data.timeSections[2]&&[new Date("Jun 2,2017 "+ res.data.timeSections[2][0]), new Date("Jun 2,2017 "+ res.data.timeSections[2][1])]
