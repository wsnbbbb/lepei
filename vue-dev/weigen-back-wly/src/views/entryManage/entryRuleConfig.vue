	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" @click="handleDistribute">下发策略</el-button>
				</el-form-item>
		...
		<el-table :data="users" highlight-current-row @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="id" label="编号" width="120" :show-overflow-tooltip="true">
			</el-table-column>
			<el-table-column prop="ruleName" label="策略名称" width="120" :show-overflow-tooltip="true">
			</el-table-column>
			<el-table-column prop="devName" label="终端名称" min-width="120" :show-overflow-tooltip="true">
			</el-table-column>
			<el-table-column prop="timeName" label="时段名称" min-width="120" :show-overflow-tooltip="true">
			</el-table-column>
...
<script>
	...
	import { getEntryRule, deleteRule ,
	 preViewEntryTime , createDevice, deleteDevice, getEntryMacList,
	distribute
	} from '../../api/api';
