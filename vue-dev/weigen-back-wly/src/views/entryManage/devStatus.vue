...
<script>
	...
	import { getUserListPage, createDevice, getEntryMacList, getPlaces, getDeviceList, removeUser, batchRemoveUser, editUser, addUser , getRecord, checkOrder, cancelCheckOrder} from '../../api/api';
