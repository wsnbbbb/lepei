...
if (process.env.NODE_ENV == 'development') {
  ...
  axios.defaults.baseURL = 'http://139.155.92.226:7005/';
  // axios.defaults.baseURL = 'http://111.231.192.93:10001';//准生产网址
  // axios.defaults.baseURL = 'http://api.lepayedu.com';//生产地址
