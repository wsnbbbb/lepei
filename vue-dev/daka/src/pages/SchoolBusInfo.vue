...
import { stringCheck, getBirthdayFromIdCard,getQueryString} from '../util/util'
...
import { Toast } from 'vant';
    ...
    export default {
        ...
        methods:{
            ...
            confirm1(value){
                this.registerDate = moment(value).format('YYYY-MM-DD');
                this.showCalendar = false
            },
            confirm2(value){
                this.healthCertificateValidity = moment(value).format('YYYY-MM-DD');
