...
import { Table,Modal, Radio,Checkbox, DatePicker,TimePicker ,Button,Select,message, Breadcrumb ,Input, Form, Row, Col, Icon,Menu, Dropdown, Pagination  } from 'antd';
import './style.less';
import moment from 'moment';
import {isBlank, dateToTimestamp, isCorrectMoney} from '../../utils/public';
...
class NewTrust extends Component{
    constructor(props) {
        super(props);
        this.state = {
            visible: false,
    ...
    render(){
        ...
        return (
            <div className="content-main content-newTrust content-building content-termManage ">
                <div className="content-box">
                    {/* <Breadcrumb>
                        <Breadcrumb.Item><Link to={"/trust-manage"}>学生托管</Link> \ 新建托管</Breadcrumb.Item>
                    </Breadcrumb> */}
                    <Row className="option-wrap">
                        ...
                        { 
                            ...
                            <Row>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;托管费用：
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <Input placeholder="请输入金额" width={100} maxLength={30} onChange={this.feeInput.bind(this)} />&nbsp;&nbsp;&nbsp;&nbsp;元
                            </Row> : null
                        }
...
export default connect(mapStateToProps)(Form.create()(NewTrust));
