...
class roleAccessStudent extends Component{
    constructor(props) {
        super(props);
        this.state = {
          visible: false,
    ...
    toDetail = (jobId) => {
      this.props.dispatch(
        routerRedux.push("/access-detail-student/" + jobId)
      )
    }
    addJob = () => {
      this.props.dispatch(
...
const mapStateToProps = (state) => {
  return {
    ...
    jobList:state.setting.cadresData,

  }
}

export default connect(mapStateToProps)(Form.create()(roleAccessStudent));
