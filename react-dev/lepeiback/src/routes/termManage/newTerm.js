        ...
        return (
            <div className="content-main content-building content-newTerm">
                <div className="content-box">
                    {/* <Breadcrumb>
                        <Breadcrumb.Item><Link to={"/term-manage"}>学期管理</Link> \ 新建学期</Breadcrumb.Item>
                    </Breadcrumb> */}
                    <Row className="option-wrap">
                        <Row>
                            学期名称 <span className="color-red">*</span>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <Input placeholder="学期名称" onChange={this.nameInput.bind(this)} />
...
export default connect(mapStateToProps)(Form.create()(NewTerm));
