...
class UnauthPerson extends Component{
    constructor(props) {
        super(props);
        this.state = {
          page:1,
...
export default connect(mapStateToProps)(Form.create()(UnauthPerson));
