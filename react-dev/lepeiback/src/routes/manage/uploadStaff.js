            ...
            callback:(res)=>{
                ...
                if(res.code===200){
                    if(res.data.hasError===true){
                        ...
                        const url=(type==1?"/teacher-manage":"/employee-manage")
            ...
            <div className="add-salary-main">
                {/* <div className="breadcrumb">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item><Link to={type==1?"/teacher-manage":"/employee-manage"}>{type==1?"教师管理":"职工管理"}</Link></Breadcrumb.Item>
                        <Breadcrumb.Item>{type==1?"教师批量导入":"职工批量导入"}</Breadcrumb.Item>
                    </Breadcrumb>
                </div> */}
                <Form className="ant-advanced-search-form salary-form">
                    ...
                    <p style={{marginLeft:"14%",color:'#aaa'}}>支持扩展名：xls,xlsx...&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href={getUpload("教师信息导入模板.xls")}>下载导入模板</a>
                    </p>
