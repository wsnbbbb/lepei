...
class WoStudentFaceReg extends Component{
    constructor(props) {
        super(props);
        this.state = {
          faceRegList:[],
        ...
        return (
            <div className="content-main student-face-reg">
              <Form className="content-form">
                <Row gutter={24}>
                  ...
                  <Col span={5}>
                    <FormItem {...formItemLayout} label={'年级'}>
                      {getFieldDecorator("gradeId",{rules: [{
                        ...
                        <Select allowClear showSearch placeholder="请选择" onChange={this.gradeChange.bind(this)}>
                          {options}
                        </Select>
                      )}
                    </FormItem>
                  ...
                  <Col span={5}>
                    <FormItem {...formItemLayout} label={'班级'}>
                        <Select allowClear showSearch placeholder="请选择" value={this.state.classValue||undefined} onChange={this.classChange} disabled={this.state.disabled}>
                          {classOptions}
                        </Select>
                    </FormItem>
                  </Col>
                  <Col span={4}>
                    <FormItem {...formItemLayout2} label={'头像状态'}>
                ...
                <Row gutter={24}>
                  <Col span={5}>
                    <FormItem {...formItemLayout2} label={'开卡状态'}>
                  ...
                  <Col span={5}>
                    <FormItem {...formItemLayout2} label={'注册状态'}>
...
export default connect(mapStateToProps)(Form.create()(WoStudentFaceReg));
