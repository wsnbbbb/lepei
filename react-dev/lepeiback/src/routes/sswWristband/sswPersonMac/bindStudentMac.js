...
class BindStudentMac extends Component{
    constructor(props) {
        super(props);
        this.state = {
            file:"",
            ...
            callback:(res)=>{
                ...
                if(res.code===200){
                    if(res.data.hasError===true){
                        ...
                        this.props.dispatch(routerRedux.push("/ssw-person-mac?key=1"))
                    }
                }
            }
        })
            ...
            <div className="add-salary-main">
                <div className="breadcrumb">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item><Link to="/ssw-person-mac?key=1">顺势为手环标签配置</Link></Breadcrumb.Item>
                        <Breadcrumb.Item>学生批量绑定</Breadcrumb.Item>
                    </Breadcrumb>
                </div>
                <Form className="ant-advanced-search-form salary-form">
                    ...
                    <p style={{marginLeft:"14%",color:'#aaa'}}>支持扩展名：xls,xlsx...&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href={getUpload("学生绑定导入模板.xls")}>下载导入模板</a>
                    </p>
                    <div className="salary-btns">
                        <Link to='/ssw-person-mac?key=1'><Button style={{marginRight:16}}>返回</Button></Link>
...
export default connect(mapStateToProps)(Form.create()(BindStudentMac));
