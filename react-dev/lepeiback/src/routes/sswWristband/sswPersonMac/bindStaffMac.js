...
class BindStaffMac extends Component{
    constructor(props) {
        super(props);
        this.state = {
            file:"",
            ...
            callback:(res)=>{
                ...
                if(res.code===200){
                    if(res.data.hasError===true){
                        ...
                        this.props.dispatch(routerRedux.push("/ssw-person-mac?key=3"))
                    }
                }
            }
        })
            ...
            <div className="add-salary-main">
                <div className="breadcrumb">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item><Link to="/ssw-person-mac?key=3">顺势为手环标签配置</Link></Breadcrumb.Item>
                        <Breadcrumb.Item>员工批量绑定</Breadcrumb.Item>
                    </Breadcrumb>
                </div>
                <Form className="ant-advanced-search-form salary-form">
                    ...
                    <div className="salary-btns">
                        <Link to='/ssw-person-mac?key=3'><Button style={{marginRight:16}}>返回</Button></Link>
...
export default connect(mapStateToProps)(Form.create()(BindStaffMac));
