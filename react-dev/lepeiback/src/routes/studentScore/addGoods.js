...
import { dateToTimestamp, isPositiveInteger} from '../../utils/public';
import './style.less';
...
class AddGoods extends Component{
    ...
    save=()=>{
      this.props.form.validateFields((err, values) => {
        ...
        this.props.dispatch({
          type: 'score/personScoreGoodsAdd',
          payload: params,
          callback: res=>{
              if(res.code===200){
            ...
            <div className="content-main student-score">
                ...
                <Form {...formItemLayout}>
                  ...
                  <Form.Item label="有效期" hasFeedback>
                    {getFieldDecorator('time', {rules: [{ type: 'array', required: true, message: '请选择时间!' }]})(
