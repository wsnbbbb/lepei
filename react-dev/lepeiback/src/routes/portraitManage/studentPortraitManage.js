...
import { Table, Button, Input, Select, Upload, Form, Row, Col, Icon,Menu, Dropdown,Modal,message} from 'antd';
...
class StudentPortraitManage extends Component{
    constructor(props) {
        super(props);
        this.state = {
          page:1,
                ...
                <Row gutter={24}>
                  ...
                  <Col span={4}>
                    <FormItem {...formItemLayout} label={'年级'}>
                      {getFieldDecorator("gradeId",{initialValue: undefined, rules: [{
                            required: true,
                            message:"请选择年级",
                            whitespace: true,
                        }]})(
...
export default connect(mapStateToProps)(Form.create()(StudentPortraitManage));
