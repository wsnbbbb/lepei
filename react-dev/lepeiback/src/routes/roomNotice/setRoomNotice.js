...
class SetRoomNotice extends Component{
    constructor(props) {
        super(props);
        this.state = {
            ...
            <div className="room-main">
                {/* <div className="breadcrumb">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item>发布教室通知</Breadcrumb.Item>
                    </Breadcrumb>
                </div> */}
                ...
                <Row gutter={24}>
                  <Col span={14}>
                    <FormItem {...formItemLayout} label={'选择教室'}>
                      {getFieldDecorator("roomIds",{initialValue:[],rules:[{required:true, message:'请选择'}]})(
                  ...
                  <Col span={14}>
                    <FormItem {...formItemLayout} label={'通知标题'}>
                      {getFieldDecorator("title",{initialValue:'',rules:[{required:true, message:'请输入标题',whitespace: true}]})(
                        <Input />
                      )}
                    </FormItem>
                  </Col>
                  <Col span={14}>
                    <FormItem {...formItemLayout} label={'内容类型'}>
                      {getFieldDecorator("contentType",{initialValue:3,rules:[{required:true, message:'请选择'}]})(
                  ...
                  {this.state.type==3?<Col span={14}>
                    <FormItem {...formItemLayout} label={'内容'}>
                      {getFieldDecorator("contentText",{initialValue:'',rules:[{required:true, message:'请输入内容'}]})(
                  ...
                  {this.state.type==2?<Col span={14}>
                    <FormItem {...formItemLayout} label={'内容'}>
                      {getFieldDecorator("contentChain",{initialValue:'',rules:[{required:true, message:'请输入内容'}]})(
                        <Input  />
                      )}
                    </FormItem>
                  </Col>:null}
...
export default connect(mapStateToProps)(Form.create()(SetRoomNotice));
