...
import {formatDate,getSexType} from '../../utils/public';
import './style.less';
...
class StaffCard extends Component{
    ...
    goToDetail=()=>{
      this.props.dispatch(routerRedux.push("/upload-card?type=3"))
    }
    ...
    export=()=>{
      this.props.form.validateFields((err, values) => {
        ...
        const url=portUrl("/manager/person-card/export?personType=3&userId="+userId+"&userType="+userType+"&accessToken="+token+
    ...
    render(){
        ...
        return (
            <div className="content-main">
              ...
              <Table className='content-table' scroll={{ x: 1000 }} columns={columns} dataSource={staffCards.dataList} pagination={false}/>
              <PageIndex getPage={this.onPageChange.bind(this)} total={staffCards.totalCount} totalPage={staffCards.totalPage} currentPage={staffCards.currentPage}/>
              <Modal
                title="开卡"
...
export default connect(mapStateToProps)(Form.create()(StaffCard));
